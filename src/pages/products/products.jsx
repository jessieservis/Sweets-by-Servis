				...
				<div className='category-container'>
					...
					<div className='products-display'>
						<div className='product-image-large'>
							<img
								src='https://images.pexels.com/photos/230325/pexels-photo-230325.jpeg?auto=compress&cs=tinysrgb&w=600'
						...
						<div className='product-image-large'>
							<img
								src='https://images.pexels.com/photos/1387070/pexels-photo-1387070.jpeg?auto=compress&cs=tinysrgb&w=600'
								alt='Cookies on cooling rack'
							/>
							<div className='product-label'>
								<h3>Lemon Balms</h3>
								<button className='btn-product'>
			...
			<section className='category-section alt-bg'>
				<div className='category-container'>
					...
					<div className='products-display'>
						...
						<div className='product-image-large'>
							<img
								src='https://images.pexels.com/photos/853005/pexels-photo-853005.jpeg?auto=compress&cs=tinysrgb&w=600'
								alt='Colorful macaroons'
							/>
							<div className='product-label'>
								<h3>Lemon Balms</h3>
								<button className='btn-product'>
